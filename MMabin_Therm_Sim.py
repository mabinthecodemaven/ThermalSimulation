...
class Controller:
    ...
    def log_temps(self):
        return '{0}min Panel Temp: {1}, Tank Temp: {2}, Water from panel: {3}'.format(self.time/60,
            round(self.panel.temp, 2), round(self.tank.temp, 2), round(self.panel.water_out_temp,2))
